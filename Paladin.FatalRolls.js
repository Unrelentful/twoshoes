...
function LoadConfig() {
	...
	*/
	...
	Scripts.Crafting = true; // Crafting system, other characters will mule crafting ingredients. See CraftingSystem.js
	...
	Config.PickitFiles.push("cuber.nip");
	 ...
	 * GOOD: Config.AttackSkill[1] = 97;
	 * GOOD: Config.AttackSkill[1] = sdk.skills.Smite;
	 * BAD: Config.AttackSkill[1] = -97;
	 * BAD: Config.AttackSkill[1] = "smite";
	 */
	...
	Config.Recipes.push([Recipe.Blood.Gloves, "Sharkskin Gloves"]); // Craft Blood Gloves
	...
	Config.KeepRunewords.push("[type] == polearm # [meditationaura] == 17 && [enhanceddamage] >= 275");
	...
	Config.KeepRunewords.push("[type] == shield || [type] == auricshields # [fcr] == 35 && [maxmana] == 112 && [itemabsorbmagic] == 8");
	
	Config.Runewords.push([Runeword.Grief, "Phase Blade", Roll.NonEth]); // Make Grief Phase Blade
	Config.KeepRunewords.push("[name] == phaseblade # [ias] >= 35 && [itemnormaldamage] >= 400");
	Config.KeepRunewords.push("[name] == phaseblade # [ias] >= 35 && [plusmaxdamage] >= 400");
	//Config.Runewords.push([Runeword.Grief, "Berserker Axe", Roll.NonEth]); // Make Grief Zerker
	//Config.KeepRunewords.push("[name] == berserkeraxe # [ias] >= 30 && [itemnormaldamage] == 400");
	
	//Config.Runewords.push([Runeword.Enigma, "Wyrmhide", Roll.NonEth]); // Make Enigma
	//Config.KeepRunewords.push("[name] == wyrmhide # [plusdefense] == 775");
